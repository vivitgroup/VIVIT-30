...
export async function POST(req: NextRequest) {
  ...
  const data = body.data ?? (() => { const { tool, ...rest } = body; return rest; })();
  let result = "";
  let provider = "";
  let prompt = "";
