...
async function clientScope(role:string,userId:string,workspaceId:string):Promise<any[]>{
 let result:any;
...
async function taskContext(role:string,userId:string,ids:string[],workspaceId:string):Promise<any[]>{
 let result:any;
...
async function mediaContext(role:string,ids:string[],workspaceId:string):Promise<any[]>{
