...
export async function POST(req:NextRequest){
  ...
  const accountManagerId=canSetupMarketing?(role==="ACCOUNT_MANAGER"?userId:str(b.accountManagerId,80)||null):null,mediaBuyerId=canSetupMarketing?(role==="MEDIA_BUYER"?userId:str(b.mediaBuyerId,80)||null):null;
