...
export default async function NewClientPage(){
  ...
  if(!["SUPER_ADMIN","ACCOUNT_MANAGER","MEDIA_BUYER","ACCOUNTANT"].includes(role))redirect("/dashboard/clients");
  ...
  const subtitle=role==="ACCOUNTANT"?"Create the commercial and billing profile. Marketing ownership is assigned by management.":role==="MEDIA_BUYER"?"Create the client profile. You will be assigned automatically as the media buyer.":"Create the client profile, assign its portal account, then add campaigns and tasks.";
