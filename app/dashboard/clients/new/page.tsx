...
export default async function NewClientPage(){
  ...
  const subtitle=role==="ACCOUNTANT"?"Create the commercial profile. Finance setup is completed from Accounts Payment.":"Create the client profile, assign its portal account, then add campaigns and tasks.";
