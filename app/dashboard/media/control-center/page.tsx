...
export default function MediaControlCenter(){
 return <div className="vx-world vx-media-cockpit" style={{display:"grid",gap:14,minWidth:0,overflow:"hidden"}}>
  ...
  <header className="vx-world-hero" style={{display:"flex",justifyContent:"space-between",gap:12,flexWrap:"wrap",alignItems:"flex-start"}}><div style={{minWidth:0}}><span className="eyebrow">VIVIT MEDIA INTELLIGENCE</span><h1 className="page-title">Media Buying Control Center</h1><p className="page-subtitle">Campaigns first. Live intelligence loads only when you ask for it.</p></div><div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}><Link href="/dashboard/marketing-lifecycle" className="btn btn-secondary" style={{textDecoration:"none"}}>Manage clients & campaigns</Link><div className="vx-live-chip"><i/>LIVE · DB</div></div></header>
