              ...
              {allFeedback.slice(0,20).map(f=>{
                ...
                return (
                  <tr key={f.id}>
                    ...
                    <td><span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:"32px",height:"32px",borderRadius:"50%",background:`${c}15`,color:c,fontWeight:800,fontFamily:"Sora,sans-serif",fontSize:"14px"}}>{s}</span></td>
                    ...
                    <td style={{fontSize:"12px",color:"var(--text-muted)",whiteSpace:"nowrap"}}>{new Date(f.createdAt).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}</td>
                  </tr>
                );
              })}
            </tbody>
