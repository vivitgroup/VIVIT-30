...
export default function GroupLogin(){
  ...
  const workspace=useMemo<Workspace>(()=>{const raw=params.get("workspace");return raw==="tech"||raw==="hospitality"?raw:"group"},[params]);
