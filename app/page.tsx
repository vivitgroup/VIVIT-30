...
const workspaces=[
  {key:"group",title:"Vivit Group",subtitle:"Executive control · consolidated decisions · cross-company view",href:"/group/login?workspace=group",accent:"#63b3ff"},
  ...
  {key:"tech",title:"Vivit Technology",subtitle:"Projects · delivery · support · SaaS · billing",href:"/group/login?workspace=tech",accent:"#56c8ff"},
  {key:"hospitality",title:"Vivit Hospitality",subtitle:"Properties · reservations · owners · operations",href:"/group/login?workspace=hospitality",accent:"#d6ad62"},
] as const;
