...
export function AIStudioRuntime(){
  useEffect(()=>{
    const onClick=async(e:MouseEvent)=>{
      ...
      catch(err:any){output.textContent=err.message||"Generation failed. Please try again.";output.style.display="block";output.style.color="var(--red)";placeholder.style.display="none";}
