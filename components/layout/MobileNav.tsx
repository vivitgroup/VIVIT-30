...
const byRole:Record<string,{icon:string;label:string;href:string}[]>={
 ...
 SALES:[{icon:"🎯",label:"Pipeline",href:"/dashboard/sales"},{icon:"📈",label:"Reports",href:"/dashboard/reports"},{icon:"📁",label:"Files",href:"/dashboard/files"},{icon:"🔔",label:"Alerts",href:"/dashboard/notifications"}],
