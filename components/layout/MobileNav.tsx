...
const byRole:Record<string,{icon:string;label:string;href:string}[]>={
 ...
 CREATOR:[{icon:"🏠",label:"Home",href:"/apps"},{icon:"🎨",label:"Tasks",href:"/dashboard/creative"},{icon:"📅",label:"Calendar",href:"/dashboard/calendar"},{icon:"📁",label:"Files",href:"/dashboard/files"},{icon:"✨",label:"AI",href:"/dashboard/ai-studio"}],
 ...
 SALES:[{icon:"🏠",label:"Home",href:"/apps"},{icon:"🎯",label:"Pipeline",href:"/dashboard/sales"},{icon:"📅",label:"Calendar",href:"/dashboard/calendar"},{icon:"💬",label:"WhatsApp",href:"/dashboard/whatsapp"},{icon:"✨",label:"AI",href:"/dashboard/ai-studio"}],
 CLIENT:[{icon:"🏠",label:"Home",href:"/apps"},{icon:"🌐",label:"Portal",href:"/dashboard/portal"},{icon:"📅",label:"Calendar",href:"/dashboard/calendar"},{icon:"📁",label:"Files",href:"/dashboard/files"},{icon:"✨",label:"AI",href:"/dashboard/ai-studio"}],
};
