...
export function OperatingSystemLauncher({role}:{role:string}){
 ...
 const byRole:Record<string,Item[]>={
  SUPER_ADMIN:[{href:"/dashboard/executive",label:"War Room",hint:"Executive health & decisions"},{href:"/dashboard/universe",label:"Universe",hint:"Clients, workload & risk"},{href:"/dashboard/operations",label:"Sonar",hint:"Operational pressure & blockers"},{href:"/dashboard/ai-studio/actions",label:"Decide",hint:"Decision engine & approved actions"},{href:"/dashboard/creative/quality",label:"Cinema",hint:"Creative quality & revision pressure"}],
  ACCOUNT_MANAGER:[{href:"/dashboard/universe",label:"Universe",hint:"Clients, workload & risk"},{href:"/dashboard/operations",label:"Sonar",hint:"Team pressure & blockers"},{href:"/dashboard/ai-studio/actions",label:"Decide",hint:"Next best client actions"},{href:"/dashboard/creative/quality",label:"Cinema",hint:"Creative review flow"}],
