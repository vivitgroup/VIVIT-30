...
const SECTIONS:{label:string;items:Item[]}[]=[
 ...
 {label:"INTELLIGENCE & TOOLS",items:[
  {icon:"✦",label:"FAHD",href:"/dashboard/ai-studio",roles:["SUPER_ADMIN","ACCOUNT_MANAGER","MEDIA_BUYER","CREATOR","SALES","ACCOUNTANT","CLIENT"]},
