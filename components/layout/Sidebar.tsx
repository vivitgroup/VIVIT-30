...
const SECTIONS:{label:string;items:Item[]}[]=[
 ...
 {label:"FINANCE & HR",items:[
  ...
  {icon:"👥",label:"HR & Team",href:"/dashboard/team",roles:["SUPER_ADMIN","HR"]},
