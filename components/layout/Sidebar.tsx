...
const SECTIONS:{label:string;items:Item[]}[]=[
 ...
 {label:"FINANCE & HR",items:[
  ...
  {icon:"➕",label:"Add Employee",href:"/dashboard/team/new",roles:["SUPER_ADMIN","HR"]},
