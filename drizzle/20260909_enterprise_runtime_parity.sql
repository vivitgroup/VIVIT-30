...
ALTER TABLE ad_campaigns ADD COLUMN IF NOT EXISTS reported_result_label text;
ALTER TABLE ad_campaigns ADD COLUMN IF NOT EXISTS reported_result_type text;
