...
export function homeFor(role:Role):string{switch(role){case Role.CLIENT:return "/dashboard/portal";case Role.CREATOR:return "/dashboard/creative";case Role.ACCOUNTANT:return "/dashboard/finance";case Role.MEDIA_BUYER:return "/dashboard/universe";case Role.SALES:return "/dashboard/sales";case Role.ACCOUNT_MANAGER:return "/dashboard/universe";default:return "/apps"}}
