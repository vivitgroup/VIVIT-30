...
export type VivitoCapability={key:string;workspace:VivitoWorkspace;label:string;risk:VivitoRisk;approvalRequired:boolean;enabled:boolean;endpoint:string|null;method:VivitoHttpMethod;permission?:PermissionKey;staticPayload?:Record<string,unknown>};
...
export const VIVITO_CAPABILITIES:readonly VivitoCapability[]=[
  ...
  {key:"hospitality.reservation_status_update",workspace:"hospitality",label:"Update reservation status",risk:"sensitive",approvalRequired:true,enabled:true,endpoint:"/api/vgroup/hospitality/reservations",method:"PATCH",permission:"reservations:update"},
  {key:"hospitality.housekeeping_create",workspace:"hospitality",label:"Create housekeeping task",risk:"write",approvalRequired:false,enabled:true,endpoint:"/api/vgroup/hospitality/operating-system",method:"POST",permission:"properties:update",staticPayload:{operation:"housekeeping"}},
  ...
  {key:"tech.timesheet_create",workspace:"tech",label:"Create timesheet",risk:"write",approvalRequired:false,enabled:true,endpoint:"/api/vgroup/tech/operations",method:"POST",permission:"projects:update",staticPayload:{operation:"timesheet"}},
