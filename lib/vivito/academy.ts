...
export const VIVITO_ACADEMY_CONTEXT=[
  ...
  "# MBA + DBA BUSINESS & MARKETING MASTERY — BATCH 08",
  VIVITO_MBA_DBA_OPERATING_DOCTRINE,
  VIVITO_TRAINING_BATCH_08_CONTEXT,
  "# STRATEGY, RESEARCH & DELIVERABLE MASTERY — BATCH 09",
  VIVITO_DELIVERABLE_OPERATING_DOCTRINE,
  VIVITO_DELIVERABLE_DESIGN_DOCTRINE,
  VIVITO_DELIVERABLE_BLUEPRINTS_CONTEXT,
  VIVITO_TRAINING_BATCH_09_CONTEXT,
  "# EXECUTIVE PDF DESIGN & PRODUCTION MASTERY — BATCH 10",
  VIVITO_PDF_MASTER_DOCTRINE,
  VIVITO_TRAINING_BATCH_10_CONTEXT,
].join("\n\n");
