...
check('VIVITO requestId protects against duplicate single-action execution',vivito.includes("vivito_action_started")&&vivito.includes('outcome uncertain')&&vivito.includes("vivito_action_executed"));
