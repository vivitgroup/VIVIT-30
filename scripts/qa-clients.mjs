...
check("Archive UI includes clients and actor",archive.includes('section("Clients","client"')&&archive.includes("actor_name"));
check("Delete Center includes clients and actor",deleted.includes('section("Clients","client"')&&deleted.includes("actor_name"));
