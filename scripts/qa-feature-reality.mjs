...
check("Tech billing workspace reads active non-archived Tech records",techBillingPage.includes("bu.code='tech' and bu.status='active'")&&techBillingPage.includes("p.archived_at is null")&&techBillingPage.includes("c.archived_at is null"));
check("Tech change request workspace reads active non-archived Tech records",techCrPage.includes("bu.code='tech' and bu.status='active'")&&techCrPage.includes("p.archived_at is null")&&techCrPage.includes("c.archived_at is null"));
