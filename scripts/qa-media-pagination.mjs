...
const followsPagingNext=source=>source.includes('d?.paging?.next')||source.includes('asRecord(d.paging).next');
check('Campaign Meta daily insights follow paging.next',platforms.includes('async function metaPages')&&followsPagingNext(platforms));
...
check('Hierarchy endpoint follows paging.next',followsPagingNext(hier));
