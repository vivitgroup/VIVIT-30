...
check("Public v1 APIs validate readable key permissions centrally",publicApiAuth.includes('READ_PERMISSIONS=new Set(["read","read_write","admin"])')&&publicApiAuth.includes("READ_PERMISSIONS.has")&&[v1c,v1t,v1m].every(s=>s.includes("authenticatePublicRead(req)")));
