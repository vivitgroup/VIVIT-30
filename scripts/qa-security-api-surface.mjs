...
for(const file of files){
  ...
  const hasAuth=/\bauth\s*\(/.test(source)||/\bsessionScope\s*\(/.test(source)||/\brequire(?:Role|Session|Auth|ApiPermission|VGroupSession)\s*\(/.test(source)||/\bVGROUP_CRON_SECRET\b/.test(source);
