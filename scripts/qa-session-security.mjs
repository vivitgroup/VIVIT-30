...
["Role and workspace changes refresh from live user record",a.includes("if(live?.role)token.role=live.role")&&a.includes("if(live?.workspace_id)token.workspaceId=live.workspace_id")],
