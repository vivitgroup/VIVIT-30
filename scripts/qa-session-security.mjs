...
["Role and workspace changes refresh from live user record",a.includes("liveRole=isRole(live?.role)?live.role:undefined")&&a.includes("token.role=liveRole")&&a.includes("token.workspaceId=live?.workspace_id||undefined")],
