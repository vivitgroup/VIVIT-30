...
const checks=[
  ...
  [audit.includes('requireGroupSuperAdmin'),'Audit API is not super-admin protected'],
  [archive.includes('requireGroupSuperAdmin'),'Archive API is not super-admin protected'],
