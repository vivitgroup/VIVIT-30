...
const checks=[
  ...
  ['API permission checks are centralized',/requireApiPermission|apiPermissionOrResponse/.test(apiAccess)],
  ['Hospitality expense API exists and is permission-gated',/requireApiPermission|apiPermissionOrResponse/.test(expensesApi)&&/hospitality/.test(expensesApi)],
  ['Hospitality property API is permission-gated',/requireApiPermission|apiPermissionOrResponse/.test(propertiesApi)],
  ['Tech operations API is permission-gated',/requireApiPermission|apiPermissionOrResponse/.test(techOps)],
