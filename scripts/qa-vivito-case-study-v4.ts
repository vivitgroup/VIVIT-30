...
pass("Account Manager receives role-relevant cases only",VIVITO_CASE_STUDY_ROLE_SCOPE.ACCOUNT_MANAGER.length===1000);
...
console.log(`\n${12-fail.length}/12 VIVITO Case Study V4 checks passed.`);if(fail.length)process.exit(1);
